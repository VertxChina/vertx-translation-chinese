...
即便对于高等级应用不需要处理它，[MqttEndpoint](http://vertx.io/docs/scaladocs/io/vertx/scala/mqtt/MqttEndpoint.html)接口依然提供了[pingHandler](http://vertx.io/docs/scaladocs/io/vertx/scala/mqtt/MqttEndpoint.html#pingHandler(io.vertx.core.Handler))方法用来选定一个handler，当收到来自客户端的PINGREQ消息会被调用。
